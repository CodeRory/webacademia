    ...
    render() {
        return(
            <div className="barraTop">                
                ...
                <ul className="redes">
                    <ul><a href=""><img src={tw}  alt="fb" height="38vh" width="38vw"/></a></ul>                    
                    <ul><a href=""><img src={insta}  alt="fb" height="38vh" width="38vw"/></a></ul>
                    <ul><a href=""><img src={fb}  alt="fb" height="38vh" width="38vw" /></a></ul>            
                </ul>    
            </div>
        );
    }
